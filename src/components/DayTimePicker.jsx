...
class DayPicker extends React.PureComponent {
  ...
  handleTimesChange(e) {
    ...
    const { onTimesChange } = this.props;
    onTimesChange(e);
  }
        ...
        <OutsideClickHandler onOutsideClick={onOutsideClick}>
          ...
          >
            ...
            >
              ...
              <div {...css(styles.DayTimePicker__times)}>
                <div {...css(styles.DayTimePicker__times_div, styles.DayTimePicker__start_time)}>
                  <label htmlFor="startTime">Início:</label>
                  <input
                    {...css(styles.DayTimePicker__times_input)}
                    type="time"
                    id="startTime"
                    name="startTime"
                    maxLength="5"
                ...
                <div {...css(styles.DayTimePicker__times_div)}>
...
export default withStyles(({
  ...
  DayTimePicker__times: {
    display: 'flex',
    padding: '24px',
  },
  DayTimePicker__times_div: {
    fontFamily: 'Helvetica, sans-serif',
    fontSize: font.size,
  },
  DayTimePicker__times_input: {
    marginLeft: '8px',
